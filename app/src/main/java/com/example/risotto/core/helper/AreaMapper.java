...
public class AreaMapper {
    ...
    static {
        ...
        AREA_TO_COUNTRY_CODE.put("Unknown", "unknown");
    }
    ...
    public static List<Country> map(List<AreaDto> areaDtos) {
        ...
        for (AreaDto dto : areaDtos) {
            ...
            if (areaName == null || areaName.equals("Unknown")) {
                continue;
            }
            ...
            String imageUrl = "https://www.themealdb.com/images/icons/flags/big/64/" + code + ".png";
